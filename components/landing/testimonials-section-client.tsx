...
// Normalize DB testimonial to display shape
...
// Fallback data (real Google reviews — kept in original language for authenticity)
const FALLBACK_TESTIMONIALS: DisplayTestimonial[] = [
  ...
  },
  {
    ...
    name: "David Elmore",
    rating: 5,
    text: "Esta casa y las personas que viven y trabajan ahí son increíbles. Los jefes son perfecto. Atmósfera estaba muy bien. Cerca de la playa, puedo caminar en diez minutos.",
    date: "Dec 2025",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    name: "Dani Vidrio",
    rating: 5,
    text: "Es un hostal increíble, está super cerca de todo, son muy amables y el lugar es demasiado lindo y cómodo. Tomé una clase de surf con ellos y me encantó, el maestro es muy bueno.",
    date: "Dec 2025",
  },
  {
    id: 5,
    name: "Serena Pasetti",
    rating: 5,
    text: "El lugar es increíble, tiene un jardín precioso y una terraza super amplia. Queda cerca del centro y de la playa. Ofrecen clases de surf y excursiones buenísimas, a mejor precio que en otros lados.",
    date: "Aug 2025",
  },
];
...
export function TestimonialsSectionClient({ dbTestimonials }: Props) {
  const testimonials =
    dbTestimonials.length > 0
      ? dbTestimonials.map(toDisplay)
